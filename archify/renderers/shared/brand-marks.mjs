...
import { RESOLVED_BY_NODE, RESOLVED_MARK } from './brand-rendering.mjs';
export { brandMarkFor, brandMetadataFor, brandLabelFitWidth, brandTopRailProblem, renderBrandMark } from './brand-rendering.mjs';
